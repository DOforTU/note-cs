...
역전파를 위해서는 중간 값들이 보존되어야 하는데, in-place 연산은 이를 덮어쓰기 때문입니다. PyTorch는 이러한 문제를 방지하기 위해 런타임 에러를 발생시킵니다.
...
Broadcasting을 사용하면 반복문 없이 배치 전체에 연산을 효율적으로 적용할 수 있습니다.
